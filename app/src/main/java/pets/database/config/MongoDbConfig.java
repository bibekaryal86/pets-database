...
public class MongoDbConfig extends AbstractMongoClientConfiguration {
  ...
  public MongoClient mongoClient() {
    ...
    String connectionString =
        String.format(
            "mongodb+srv://%s:%s@%s.lwcmb.mongodb.net/%s?retryWrites=true&w=majority",
            mongoConfig.get(MONGODB_USR_NAME),
            mongoConfig.get(MONGODB_USR_PWD),
            mongoConfig.get(MONGODB_ACC_NAME),
            database);
