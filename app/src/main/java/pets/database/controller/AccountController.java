...
public class AccountController {
    ...
    public ResponseEntity<AccountResponse> getAccountsByUsername(@PathVariable("username") String username) {
        if (!hasText(username)) {
    ...
    public ResponseEntity<AccountResponse> saveNewAccount(@RequestBody AccountRequest accountRequest) {
    ...
    public ResponseEntity<AccountResponse> updateAccount(@PathVariable("id") String id, @RequestBody AccountRequest accountRequest) {
