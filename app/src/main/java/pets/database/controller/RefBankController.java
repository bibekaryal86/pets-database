...
public class RefBankController {
    ...
    public ResponseEntity<RefBankResponse> saveNewRefBank(@RequestBody RefBankRequest refBankRequest) {
    ...
    public ResponseEntity<RefBankResponse> updateRefBank(@PathVariable("id") String id,
    ...
    private ResponseEntity<RefBankResponse> response(String errMsg) {
        return new ResponseEntity<>(RefBankResponse.builder()
                .refBanks(emptyList())
                .deleteCount(0L)
