...
public class RefCategoryController {
    ...
    public ResponseEntity<RefCategoryResponse> saveNewRefCategory(@RequestBody RefCategoryRequest refCategoryRequest) {
    ...
    public ResponseEntity<RefCategoryResponse> updateRefCategory(@PathVariable("id") String id,
    ...
    private ResponseEntity<RefCategoryResponse> response(String errMsg) {
        return new ResponseEntity<>(RefCategoryResponse.builder()
