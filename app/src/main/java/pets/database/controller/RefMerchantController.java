...
public class RefMerchantController {
    ...
    public ResponseEntity<RefMerchantResponse> getAllRefMerchantsByUsername(@PathVariable("username") String username) {
        if (!hasText(username)) {
    ...
    public ResponseEntity<RefMerchantResponse> saveNewRefMerchant(@RequestBody RefMerchantRequest refMerchantRequest) {
    ...
    public ResponseEntity<RefMerchantResponse> updateRefMerchant(@PathVariable("id") String id,
    ...
    private ResponseEntity<RefMerchantResponse> response(String errMsg) {
        return new ResponseEntity<>(RefMerchantResponse.builder()
