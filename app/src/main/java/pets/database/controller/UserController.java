...
public class UserController {
    ...
    public ResponseEntity<UserResponse> getUserByUserName(@PathVariable("username") String username,
        ...
        if (!hasText(username)) {
            ...
            return response(format("Error Retrieving User by Invalid Username and Header: %s | %s", username, userHeader));
        } else {
    ...
    public ResponseEntity<UserResponse> updateUser(@PathVariable("id") String id, @RequestBody Map<String, Object> newValues) {
