...
public class Constants {
    ...
    public static final String COLLECTION_NAME_REF_CATEGORY_TYPE_DETAILS = "ref_category_type_details";
    public static final String COLLECTION_NAME_REF_MERCHANT_DETAILS = "ref_merchant_details";
    public static final String COLLECTION_NAME_REF_TRANSACTION_TYPE_DETAILS = "ref_transaction_type_details";
