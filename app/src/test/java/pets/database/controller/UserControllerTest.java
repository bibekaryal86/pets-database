...
class UserControllerTest {
  ...
  void init() throws JsonProcessingException {
    ...
    userRequest =
        new UserRequest(USER_NAME, "pass-word", "first-name", "last-name", EMAIL, PHONE, "status");
    expectedUserResponse =
        UserResponse.builder()
            .users(
                singletonList(
                    objectMapper().readValue(readFixture("fixtures/user/user.json"), User.class)))
            .build();
  ...
  void getAllUsers_returnsError() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(
                Status.builder().errMsg("Error Retrieving All Users, Please Try Again!!!").build())
            .build();

    when(userService.getAllUsers()).thenReturn(expectedUserResponseError);
  ...
  void getAllUsers_returnsResponse() {
    ...
    when(userService.getAllUsers()).thenReturn(expectedUserResponse);
  ...
  void getUserById_returnsError_400() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Retrieving User by Invalid id: ").build())
            .build();
  ...
  void getUserById_returnsError_500() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg(ERROR_RETRIEVING_USER).build())
            .build();

    when(userService.getUserById(any())).thenReturn(expectedUserResponseError);
  ...
  void getUserById_returnsResponse() {
    when(userService.getUserById(any())).thenReturn(expectedUserResponse);
  ...
  void getUserByUsername_returnsError_400_noUsername() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Retrieving User by Invalid Username: ").build())
            .build();

    ResponseEntity<UserResponse> actualUserResponse =
        userController.getUserByUserName("", "user-header");
    ...
    expectedUserResponseError =
        UserResponse.builder()
            ...
            .status(
                Status.builder()
                    .errMsg(
                        "Error Retrieving User by Invalid Username and Header: user-name | user-header")
                    .build())
            .build();

    ResponseEntity<UserResponse> actualUserResponse =
        userController.getUserByUserName(USER_NAME, "user-header");
  ...
  void getUserByUsername_returnsError_500() {
    ...
    when(userService.getUserByUsername(any())).thenReturn(expectedUserResponseError);

    ResponseEntity<UserResponse> actualUserResponse =
        userController.getUserByUserName(USER_NAME, USER_NAME);
  ...
  void getUserByUsername_returnsResponse() {
    when(userService.getUserByUsername(any())).thenReturn(expectedUserResponse);
  ...
  void getUserByEmail_returnsError_400() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Retrieving User by Invalid Email: ").build())
            .build();
  ...
  void getUserByEmail_returnsError_500() {
    ...
    when(userService.getUsersByEmailOrPhone(any(), any())).thenReturn(expectedUserResponseError);
  ...
  void getUserByEmail_returnsResponse() {
    when(userService.getUsersByEmailOrPhone(any(), any())).thenReturn(expectedUserResponse);
  ...
  void getUserByPhone_returnsError_400() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Retrieving User by Invalid Phone: ").build())
            .build();
  ...
  void saveNewUser_returnsError_400() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Saving User by Invalid Request!!!").build())
            .build();
  ...
  void saveNewUser_returnsError_500() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Saving User, Please Try Again!!!").build())
            .build();

    when(userService.saveNewUser(any())).thenReturn(expectedUserResponseError);
  ...
  void saveNewUser_returnsResponse() {
    when(userService.saveNewUser(any())).thenReturn(expectedUserResponse);
  ...
  void updateUser_userRequest_returnsError_400_noId() {
    expectedUserResponseError =
        UserResponse.builder()
            ...
            .deleteCount(0L)
            .status(
                Status.builder().errMsg("Error Updating User by Invalid id / request: ").build())
            .build();
  ...
  void updateUser_userRequest_returnsError_400_noRequest() {
    expectedUserResponseError =
        UserResponse.builder()
            ...
            .deleteCount(0L)
            .status(
                Status.builder().errMsg("Error Updating User by Invalid id / request: id").build())
            .build();

    ResponseEntity<UserResponse> actualUserResponse =
        userController.updateUser("id", (UserRequest) null);
  ...
  void updateUser_userRequest_returnsError_500() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Updating User, Please Try Again!!!").build())
            .build();
  ...
  void updateUser_userRequest_returnsResponse() {
    when(userService.updateUserById(any(), (UserRequest) any())).thenReturn(expectedUserResponse);
  ...
  void updateUser_newValuesMap_returnsError_400_noId() {
    expectedUserResponseError =
        UserResponse.builder()
            ...
            .deleteCount(0L)
            .status(
                Status.builder().errMsg("Error Updating User by Invalid id / newValues: ").build())
            .build();
  ...
  // when(userService.updateUserById(any(), (Map<String, Object>)
  // any())).thenReturn(expectedUserResponseError);  //NOSONAR
  ...
  void updateUser_newValuesMap_returnsError_400_noRequest() {
    ...
    ResponseEntity<UserResponse> actualUserResponse =
        userController.updateUser("id", (Map<String, Object>) null);
  ...
  void deleteUser_returnsError_400() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Deleting User by Invalid id: ").build())
            .build();
  ...
  void deleteUser_returnsError_500() {
    expectedUserResponseError =
        UserResponse.builder()
            .users(emptyList())
            .deleteCount(0L)
            .status(Status.builder().errMsg("Error Deleting User, Please Try Again!!!").build())
            .build();

    when(userService.deleteUserById(any())).thenReturn(expectedUserResponseError);
  ...
  void deleteUser_returnsResponse() {
    when(userService.deleteUserById(any())).thenReturn(expectedUserResponse);
