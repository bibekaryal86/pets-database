...
public class TransactionController {
    ...
    public ResponseEntity<TransactionResponse> getTransactionsByUser(@PathVariable("username") String username) {
        if (!hasText(username)) {
    ...
    public ResponseEntity<TransactionResponse> saveNewTransaction(@RequestBody TransactionRequest transactionRequest) {
    ...
    public ResponseEntity<TransactionResponse> updateTransaction(@PathVariable("id") String id,
    ...
    public ResponseEntity<TransactionResponse> deleteTransactionsByAccountId(@PathVariable("accountid") String accountId) {
