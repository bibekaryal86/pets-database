...
public class RefCategoryTypeDao {
    ...
    public List<RefCategoryType> getAllRefCategoryTypes() {
        ...
        return mongoTemplate.find(query, RefCategoryType.class, COLLECTION_NAME_REF_CATEGORY_TYPE_DETAILS);
    }

    public RefCategoryType getRefCategoryTypeById(String id) {
        return mongoTemplate.findOne(Query.query(Criteria.where(FIELD_NAME_ID).is(id)), RefCategoryType.class,
    ...
    public long updateRefCategoryTypeById(String id, Update update) {
        return mongoTemplate.updateFirst(Query.query(Criteria.where(FIELD_NAME_ID).is(id)), update,
                RefCategoryType.class, COLLECTION_NAME_REF_CATEGORY_TYPE_DETAILS).getModifiedCount();
    }

    public long deleteRefCategoryTypeById(String id) {
        return mongoTemplate.remove(Query.query(Criteria.where(FIELD_NAME_ID).is(id)), RefCategoryType.class,
