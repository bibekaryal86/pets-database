...
public class UserControllerTest {
    ...
    @Test
    public void getAllUsers_returnsError() {
    ...
    @Test
    public void getUserById_returnsError_400() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserById_returnsError_500() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByUsername_returnsError_400_noUsername() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByUsername_returnsError_400_userNameDifferentHeader() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByUsername_returnsError_500() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByEmail_returnsError_400() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByEmail_returnsError_500() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByEmail_returnsResponse() {
        when(userService.getUsersByEmailOrPhone(any(), any()))
                .thenReturn(expectedUserResponse);
    ...
    @Test
    public void getUserByPhone_returnsError_400() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByPhone_returnsError_500() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void getUserByPhone_returnsResponse() {
        when(userService.getUsersByEmailOrPhone(any(), any()))
                .thenReturn(expectedUserResponse);
    ...
    @Test
    public void saveNewUser_returnsError_400() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void saveNewUser_returnsError_500() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void updateUser_userRequest_returnsError_400_noId() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void updateUser_userRequest_returnsError_400_noRequest() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void updateUser_userRequest_returnsError_500() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void updateUser_userRequest_returnsResponse() {
        when(userService.updateUserById(any(), (UserRequest) any()))
                .thenReturn(expectedUserResponse);
    ...
    @Test
    public void updateUser_newValuesMap_returnsError_400_noId() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void updateUser_newValuesMap_returnsError_400_noRequest() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void deleteUser_returnsError_400() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void deleteUser_returnsError_500() {
        expectedUserResponseError = UserResponse.builder()
                .users(emptyList())
                .deleteCount(0L)
                .status(Status.builder()
    ...
    @Test
    public void deleteUser_returnsResponse() {
        when(userService.deleteUserById(any()))
                .thenReturn(expectedUserResponse);
