...
public class UserDaoTest {
    ...
    public void getAllUsers_returnsUsers() {
        List<User> expectedUserList = asList(
                User.builder()
        ...
        when(mongoTemplate.findAll(User.class))
    ...
    public void findUserById_returnsUser() {
        when(mongoTemplate.findOne(any(), eq(User.class)))
    ...
    @Test
    public void findByEmailOrPhone_findsByEmail_returnsUser() {
        when(mongoTemplate.findOne(any(), eq(User.class)))
                .thenReturn(expectedUser);
    ...
    @Test
    public void findByEmailOrPhone_findsByPhone_returnsUser() {
        when(mongoTemplate.findOne(any(), eq(User.class)))
                .thenReturn(expectedUser);
    ...
    @Test
    public void saveNewUser_returnsUser() {
        when(mongoTemplate.save(any(), anyString()))
                .thenReturn(expectedUser);
    ...
    @Test
    public void updateUserById_returnsUpdateCount() {
    ...
    @Test
    public void deleteUserById_returnsDeleteCount() {
        ...
        when(mongoTemplate.remove(any(), eq(User.class)))
